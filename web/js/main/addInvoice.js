...
function saveInDBFunction() {
  ...
  var selfAddress = $('#selfAddress').val().trim().replace(/[^a-zA-Z0-9 ]/g, "");
  var selfPhone = $('#selfPhone').val().trim().replace(/[^0-9 ]/g, "");
  var selfGst = $('#selfGst').val().trim().replace(/[^a-zA-Z0-9 ]/g, "");
  var gstPercent = $('#gstPercent').val().trim();
  var PartyName = $('#PartyName').val().trim().replace(/[^a-zA-Z ]/g, "");
  var PartyAddress = $('#PartyAddress').val().trim().replace(/[^a-zA-Z0-9 ]/g, "");
  var PartyPhone = $('#PartyPhone').val().trim().replace(/[^0-9 ]/g, "");
  var PartyGst = $('#PartyGst').val().trim().replace(/[^a-zA-Z0-9 ]/g, "");
