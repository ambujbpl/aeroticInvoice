function print_today() {
  ...
  return today;
  // Here we can use Moment plugin as well for operation
}

//i taken that function from http://www.mediacollege.com/internet/javascript/number/round.html
...
function update_total() {
  ...
  $('#subtotal').html(total);
  var apply_Gst = get_Gst(total);
  // my new gst calculation function
  $('#gst').html((apply_Gst));
  // console.log("apply_Gst===",apply_Gst);
  total = Number(total) + Number(apply_Gst);
  $('#total').html((total));
...
$(document).ready(function() {
  ...
  bind();
  $('body').on('click', '.delete', function () {//used dynamically add dom removing purpose function
  // $(".delete").live('click',function(){    it used with old jquery-1.3.2 dynamically add dom delete purpose
